                ...
                <nav class="pading-none">
                    <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview ">
                            <div class="custom-control custom-checkbox checkbox-lg padding-none"
                                style="z-index: 12; position: absolute; margin-top:-8px; margin-left:2px;">
                                <input type="checkbox" class="custom-control-input " id="{{ $item->nama }}" checked="">
                                <label class="custom-control-label" for="{{ $item->nama }}"></label>
                            </div>
                            <a href="#" class="nav-link ml-4 pb-2">
                                        ...
                                        <div class="row padding-none">
                                            ...
                                            <div class="col-3">
                                                <img src="storage/{{ $items->icon }}" alt=""
                                                    style="width: 25px; margin-top:0px; margin-left:40px;" srcset="">
                                            </div>
                                        </div>
                                    </a>
                                </li>
...
<script>
    ...
    function onClick(e) {
        ...
        $('ul li h3 .pot').text(e.target.feature.properties.potensi);
        $('ul li h3 .sub').text(e.target.feature.properties.bangunan);
        $('ul li .na').text(e.target.feature.properties.nama);
        $('ul li h3 .lok').text(e.target.feature.properties.lokasi);

        var text = (e.target.feature.properties.deskripsi!= null)?e.target.feature.properties.deskripsi.replace(/\r?\n/g,"<br />"):'Tidak ada Deskripsi';
        $('ul li .des').html(text);
