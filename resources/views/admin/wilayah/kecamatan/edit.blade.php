...
<div class="row">
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        ...
        <form class="forms-sample"method="post" action="{{route('wilayah.kecamatan.update',$data->id)}}">
            @csrf
            @method('PUT')
              <div class="row">
                  <div class="col-12">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                      ...
                      <option value="{{$data->kabupaten->id}}">{{$data->kabupaten->nama}}</option>
              ...
              <div class="col-6">
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="jenis"  placeholder="jenis" value="{{$data->Jenis}}">
                  </div>
              </div>
            </div>
