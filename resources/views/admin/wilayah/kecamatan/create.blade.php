...
<div class="row">
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Masukkan Data Kabupaten</h4>
        <form class="forms-sample"method="post" action="{{route('wilayah.kecamatan.store')}}">
            @csrf
              <div class="row">
                  <div class="col-12">
             ...
             <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group">
                      ...
                      <input  type="text" class="form-control" name="jenis"  placeholder="jenis" value=" ">
                    </div>
                </div>
