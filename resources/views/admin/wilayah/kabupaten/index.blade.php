    ...
    <div class="col-md-12 stretch-card">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-10"><h4 class="text mt-2" >SEMUA Kabupaten</h4></div>
          <div class="col-2"> <a  href="{{route('wilayah.kabupaten.create')}}" class="btn btn-success text-white ">Tambah Data</a></div>
           </div>
