    ...
    <div class="col-md-12 stretch-card">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-10"><h4 class="text mt-2" >SEMUA ASET PERBATASAN POTENSI LISTRIK</h4></div>
          <div class="col-2"> <a  href="{{route('potensi.listrik.create')}}" class="btn btn-success text-white ">Tambah Data</a></div>
           </div>
